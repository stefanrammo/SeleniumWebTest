...
namespace LearnSelenium
    ...
    public class Tests
    {
        ...
        public void TestPage1()
        {
            ...
            try { IWebElement sButton2 = driver.FindElement(By.XPath("//*[contains(@class, 'menu-item-1272')]")); sButton2.Click(); } catch (Exception) { }
            Thread.Sleep(2500);
        }
        ...
        public void TestPage3()
        {
            ...
            try { IWebElement sButton2 = driver.FindElement(By.XPath("//*[contains(@class, 'menu-item-150')]")); sButton2.Click(); } catch (Exception) { }
            Thread.Sleep(2500);
